...
#          will be found in the dognames.txt file. The dog names in dognames.txt
#          will be read into a dictionary where the 'key' is the 
...
#           that's the 'value' of the results dictionary. The CODE will be adding the
...
def adjust_results4_isadog(results_dic, dogfile):
    """
    The function determines if classifier correctly 
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":  
            ...
            #          Checks if the dogname(line) exists within dognames_dic,
            #          then if the dogname(line) doesn't exist within dognames_dic 
            #          then the dogname(line) to dognames_dic as the 'key' 
            #          with the 'value' of 1 is added. 
            #
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            #           The CODE adds the following to results_dic dictionary
            #           for the key indicated by the variable key
            #            - append (1,0) to the value using 
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            #           The CODE adds the following to results_dic dictionary
            #           for the key indicated by the variable key
            #            - append (0,0) to the value using the 
