...
# DATE CREATED: 15TH OCTOBER 2021                                  
# REVISED DATE: 15TH OCTOBER 2021 
# PURPOSE: Classifies pet images using a pretrained CNN model, compares these
#          classifications to the true identity of the pets in the images, and
#          summarizes how well the CNN performed on the image classification task. 
#          Note that the true identity of the pet (or object) in the image is 
#          indicated by the filename of the image. Therefore, the program
#          first extracts the pet image label from the filename before
...
def main():
    ...
    # get_input_args function within the file get_input_args.py
    ...
    # get_pet_labels function within the file get_pet_labels.py
    ...
    print('\nTotal Elapse Runtime:' + str(hours) + ':' + str(minutes) + ':' + str(seconds))    
