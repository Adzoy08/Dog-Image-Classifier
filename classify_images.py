...
# DATE CREATED: 17TH OCTOBER 2021                                 
# REVISED DATE: 17TH OCTOBER 2021
...
def classify_images(images_dir, results_dic, model):
    ...
    the labels to the results dictionary using the extend function. The CODE
    formats the classifier labels so that they will match the pet image labels.
    ...
    for key in results_dic:
       ...
       #           The CODE process the model_label to convert all characters
       #           within model_label to lowercase letters and then remove
       #           whitespace characters from the ends of model_label.
       #           Be certain the resulting processed string is named model_label.
       #  
