...
# DATE CREATED: 18TH OCTOBER 2021                                  
# REVISED DATE: 18TH OCTOBER 2021
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        #           The CODE counts how many pet images of dogs had their
        #           breed correctly classified. This happens when the
        #           pet image label indicates the image is-a-dog AND 
        #           the pet image label and the classifier label match.  
        #           The conditional statement determines when the dog breed
        #           is correctly classified and then adds 1 to 'n_correct_breed'.
        #           'n_correct_breed' is a key in the results_stats_dic dictionary
        ...
        #           The CODE counts how many pet images that are NOT dogs
        #           were correctly classified. This happens when the pet
        #           image label indicates the image is-NOT-a-dog AND the 
        #           classifier label indicates the images is-NOT-a-dog.
        #           A conditional statement that determines when the classifier
        #           label indicates the image is-NOT-a-dog and adds 1 to 'n_correct_notdogs'.            
        #           The 'else:' already indicates that the pet image label
        #           indicates the image is-NOT-a-dog and 'n_correct_notdogs' is a key
        #           in the results_stats_dic dictionary with it's value representing
    ...
    #           The CODE that calculates the % of correctly matched images.
    #           'n_match' divided by the 'n_images' multiplied by 100.0       
    #    
    # Calculates % correct for matches
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] / results_stats_dic['n_images']) * 100.0

    #           The CODE that calculates the % of correctly classified dog images
    #           'n_correct_dogs' divided by 'n_dogs_img' multiplied by 100.0       
    #    
    # Calculates % correct dogs
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img']) * 100.0

    #           The CODE that calculates the % of correctly classified breeds of dogs.
    #           'n_correct_breed' divided by 'n_dogs_img' multiplied by 100.0
    #    
